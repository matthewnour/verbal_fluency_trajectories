...
%
    ...
    methods(Static)
            ...
            if ischar(csvFileOrData) && ...
                ...
                try
                    [csvFileOrData, args.column_names, ...
                        ...
                        ~, args.store]=FlowJoTree.GetData(...
                        csvFileOrData,...
                        args.flowjo_columns, ...
                        args.flowjo_visible, ...
                        args.label_column==0, false, ...
                        [], args.store, ...
                        'EPP', args.flowjo_ask);
        ...
        function HandleCytometerArgsForModal2(cy, sp)
            isArgs=isa(sp, 'Args');
            if strcmpi(cy, 'cytof')
                W=.022;
                sigma=3;
        ...
        function argsObj=SetArgsMetaInfo(argsObj) 
            ...
            argsObj.setArgGroup({'balanced', 'balancedNoisy', ...
