...
%                       The default is 3.
%
%  'balance_power'      A number used when splitter=modal and balanced=true. 
%                       This is the exponent for balance factor.  A value
%                       of 2 squares the factor and increases the penalty 
%                       for imbalance.
%                       The default is 1.
%
% 'min_relative'        A number used when splitter=modal.   This is 
%                       the minimum fraction of total events to try 
%                       to split.
%                       Default is .005.
%
...
%                       to wide kernel bandwidt, string values are 
...
%
%
%   'flowjo_visible'        Allows the user to explore and adjust the gates
...
%                         Default is true;
%
%   'max_stain'           50-100 max % of scale for stain measurements.
%                         EPP ignores events below this.  
%                         Only FlowJo bridge uses this.  Default is 95.
%                           
%   'max_scatter'         50-100 max % of scale for scatter measurements.
%                         EPP ignores events below this.  
%                         Only FlowJo bridge uses this.  Default is 90.
%
%                              
%   EXAMPLES 
...
%
%       run_epp('all_3-3.fcs/Sing*/Live*@https://storage.googleapis.com/cytogenie.org/GetDown2/domains/FACS/demo/bCellMacrophageDiscovery/eliver3.wsp', 'label_column', 'end',  'cytometer', 'conventional')
%
%   10. Same as 9, but allow user to explore and adjust manual gates first.
%
%       run_epp('all_3-3.fcs/Sing*/Live*@https://storage.googleapis.com/cytogenie.org/GetDown2/domains/FACS/demo/bCellMacrophageDiscovery/eliver3.wsp', 'label_column', 'end',  'cytometer', 'conventional', 'flowjo_visible', true)
%
%  ALGORITHM
