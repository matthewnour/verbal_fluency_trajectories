...
%   License: BSD 3 clause
    ...
    methods
        ...
        function ok=concludeDbm(this, makePolygon, jd)
            ...
            if ~makePolygon
                ...
                if ~this.newRoi(RoiUtil.POLYGON, this.dbmROI)
                    msgError(struct('msg', 'No cluster picks...', ...
        ...
        function [mxG, mxR, count]=replace(this, r, minRatio)
            mxG=[];
            mxR=[];
            if nargin<3
                minRatio=.1;
            ...
            if ratio>=minRatio
                ...
                if ~askYesOrNo(Html.SprintfHr(['"This gate overlaps' ...
        ...
        function ok=newRoi(this, roiType, roi_)
            ...
            if ~isempty(roi_)
                [mxG, mxR, count]=this.replace(roi_);
                if isempty(mxG)
                    XY=this.scale(this.rows);
                    X=XY{1};
                    Y=XY{2};
