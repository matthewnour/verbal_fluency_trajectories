        ...
        function [mds, fig]=New(names, measurementNames, ...
            ...
            function notifyMouse(~, isMotion, idx,x, y)
                ...
                elseif idx>0
                    ...
                    tip=names{idx};
                    Gui.ShowToolTipHere(tip, jBtnGenie,...
                        ax, fig, app, 6, ...
                        [], false, x, y);
                end
            end
        ...
        function [fig_, ax_]=newFig(this, name, standardBars, ...
            ...
            if ~standardBars
                ...
                ToolBarMethods.addButton(this.tb, ...
                    'svg.png', 'Create SVG File', @(h,e)svg(this));            
            ...
            if ~isempty(fig_)
                ...
                if this.useComboBoxes
                    if size(this.allMeasurements,2)>2
                        ToolBarMethods.addButton(this.tb, 'subsetArrow2.png', ...
                            'See dropdowns', @(h,e)tinker(this));
                        ToolBarMethods.addButton(this.tb, 'table.gif', ...
                            'Configure dimensions', @(h,e)reconfigureDimensions(this));
                    end
                end
            end 
