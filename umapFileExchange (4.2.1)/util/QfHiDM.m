...
%   License: BSD 3 clause
    ...
    methods
        ...
        function done=compute(this, pu, convertIdsToCellStrings, ...
            ...
            if args.askRobustConcordance
                args.robustConcordance=askYesOrNo(Html.WrapHr( ...
                    'Do robust concordance?<br>(costs more time)'), ...
                    'Confirm....', 'center', true, [], ...
                    'QfHiDM.ROBUST_CONCORDANCE');
            end
            if nargin<4
                totalSteps='/5';
        ...
        function [data, unmatched,matchesStr, hasConcordance, colors]...
    ...
    methods(Access=private)
        ...
        function collectBestMatches(this, M, toCellStrings)
            ...
            function cnt=makeMatch(best)
                ...
                if this.areEqual && this.args.robustConcordance
