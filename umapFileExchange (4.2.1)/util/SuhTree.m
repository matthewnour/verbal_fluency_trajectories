...
%   License: BSD 3 clause
    ...
    methods
        ...
        function uiNode=ensureVisible(this, id, ...
                selectIf1MutliIf2, scroll, javaBag4Paths)
            if nargin<5
                javaBag4Paths=[];
                if nargin<4
                    scroll=true;
        ...
        function ok=ensureChildUiNodesExist(this, uiNode, force)
            if nargin<3
                force=false;
            end
            if ischar(uiNode)
            ...
            if uiN~=nonUiN || force
                ...
                if nUiChildren>0
                    for i=1:nonUiN
                        ...
                        existed=this.uiNodes.containsKey(children{i});
                        this.uiNodes.put(java.lang.String(children{i}), uiChild);
                        if removedAll || ~existed
                            uiNode.add(uiChild);
                        end
                    end
                end
